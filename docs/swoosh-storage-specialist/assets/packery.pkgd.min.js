...
Packery.hero=function(e){"use strict";function t(e,a){if(!(e.maxY>a)){for(var n=document.createDocumentFragment(),o=[],i=0;i<4;i++){var d=r();o.push(d),n.appendChild(d)}e.element.appendChild(n),e.appended(o),setTimeout(function(){t(e,a)},40)}}function r(){var e=document.createElement("div");return e.className="hero__grid__item",e.style.width=Math.round(Math.random()*Math.random()*110+20)+"px",e.style.height=Math.round(Math.random()*Math.random()*90+20)+"px",e}var a=e.querySelector(".hero__grid"),n=new Packery(a,{itemSelector:".hero__grid__item",stamp:".hero__grid__stamp",gutter:2,containerStyle:null});t(n,e.offsetHeight+40)};
Packery.hero(document.querySelector(".hero__grid-container"));
